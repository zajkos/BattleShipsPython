...
def create_game_state(player1_conn, player1_username, player1_id):
    return {
        "players": [
            {"conn": player1_conn, "username": player1_username, "user_id": player1_id, "ready": False},
            None
        ],
        "turn": 0,
        "boards": [{}, {}],
        ...
        while True:
            ...
            for msg_str in messages:
                ...
                if action == "register":
                    ...
                    rooms[room_code] = create_game_state(conn, username, current_db_user_id)
